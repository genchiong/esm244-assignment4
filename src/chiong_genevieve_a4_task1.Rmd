---
title: "Santa Barbara Coastal stream chemistry: agglomerative hierarchal clustering"
...
# Wrangle the data so that there is a single summary row per site (based on means from all observations at that site) 
...
# Scale the numeric variables (columns 2:10)
